...
```
    ...
    DustSystemGenerator{var"##OdinModel#277"}(var"##OdinModel#277"(0, [:incidence, :S, :E, :I, :R], [:beta, :sigma, :gamma, :k_E, :k_I, :I0, :N], false, true, false, false))
...
```
    ...
    MontySamples([0.6 0.5353823538285275 … 0.3033839607280339 0.3033839607280339; 0.15 0.16070714191602486 … 0.049145120500701196 0.049145120500701196; 0.08 0.06638709729983794 … 0.01209715009897009 0.01209715009897009;;;], [-7.495934924878691e6; -7.327190327273927e6; … ; -1.3395102153809394e6; -1.3395102153809394e6;;], [0.6; 0.15; 0.08;;], ["beta", "sigma", "gamma"], Dict{Symbol, Any}(:acceptance_rate => [0.008666666666666666]))
...
```
    ...
    Parameter estimates (posterior mean ± std):
      β: 0.328 ± 0.043 (true: 0.8)
      σ: 0.046 ± 0.005 (true: 0.2)
      γ: 0.011 ± 0.003 (true: 0.1)
