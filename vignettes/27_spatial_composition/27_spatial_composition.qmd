...
1. **Stratify** the base SIR by patch labels — this creates per-patch compartments (`S_p1`, `I_p1`, etc.)
2. **Compose** with a migration sub-model — this adds movement transitions between patches
