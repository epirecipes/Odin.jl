# SARS-CoV-2 Multi-Region: Coupled Epidemics with Shared Parameters (R)
...
![](19_sarscov2_multiregion_files/figure-commonmark/unnamed-chunk-2-1.png)
...
```
    ...
    ℹ Re-compiling odin.system9ee17932

    ── R CMD INSTALL ───────────────────────────────────────────────────────────────
    * installing *source* package ‘odin.system9ee17932’ ...
    ** this is package ‘odin.system9ee17932’ version ‘0.0.1’
    ...
    ** libs
    ...
    In file included from dust.cpp:265:
    ...
    /Library/Frameworks/R.framework/Versions/4.5-arm64/Resources/library/dust2/include/dust2/r/continuous/system.hpp:34:33: note: in instantiation of function template specialization 'monty::random::r::as_rng_seed<monty::random::xoshiro_state<unsigned long long, 4, monty::random::scrambler::plus>>' requested here
       34 |   auto seed = monty::random::r::as_rng_seed<rng_state_type>(r_seed);
          |                                 ^
    dust.cpp:271:20: note: in instantiation of function template specialization 'dust2::r::dust2_continuous_alloc<odin_system>' requested here
      271 |   return dust2::r::dust2_continuous_alloc<odin_system>(r_pars, r_time, r_time_control, r_n_particles, r_n_groups, r_seed, r_deterministic, r_n_threads);
          |                    ^
    2 warnings generated.
    clang++ -arch arm64 -std=gnu++17 -dynamiclib -Wl,-headerpad_max_install_names -undefined dynamic_lookup -L/Library/Frameworks/R.framework/Resources/lib -L/opt/R/arm64/lib -o odin.system9ee17932.so cpp11.o dust.o -F/Library/Frameworks/R.framework/.. -framework R
    installing to /private/var/folders/yh/30rj513j6mn1n7x556c2v4w80000gn/T/RtmpeWxCJN/devtools_install_15fd52e5a5c10/00LOCK-dust_15fd54ad52e0f/00new/odin.system9ee17932/libs
    ** checking absolute paths in shared objects and dynamic libraries
    * DONE (odin.system9ee17932)

    ℹ Loading odin.system9ee17932
...
![](19_sarscov2_multiregion_files/figure-commonmark/unnamed-chunk-6-1.png)
...
![](19_sarscov2_multiregion_files/figure-commonmark/unnamed-chunk-7-1.png)
...
![](19_sarscov2_multiregion_files/figure-commonmark/unnamed-chunk-8-1.png)
...
![](19_sarscov2_multiregion_files/figure-commonmark/unnamed-chunk-9-1.png)
...
```
    ...
    Total observed cases: 929237 

``` r
cat("Cases per region:", colSums(obs_cases), "\n")
```

    Cases per region: 570735 330101 28401 
...
![](19_sarscov2_multiregion_files/figure-commonmark/unnamed-chunk-11-1.png)
...
```
    ...
    Log-likelihood at true parameters: -797.11 
...
```
    ...
    ✔ Sampled 3000 steps across 1 chain in 1.5s
...
![](19_sarscov2_multiregion_files/figure-commonmark/unnamed-chunk-18-1.png)
...
```
      ...
      rho (reporting): 0.301 [0.299, 0.302]  (true=0.3)

``` r
summarise_param("IFR", ifr_post, 0.005)
```

      IFR: 0.00501 [0.00493, 0.00508]  (true=0.005)
...
![](19_sarscov2_multiregion_files/figure-commonmark/unnamed-chunk-20-1.png)
...
![](19_sarscov2_multiregion_files/figure-commonmark/unnamed-chunk-22-1.png)
...
![](19_sarscov2_multiregion_files/figure-commonmark/unnamed-chunk-23-1.png)
...
![](19_sarscov2_multiregion_files/figure-commonmark/unnamed-chunk-24-1.png)
