...
```
    ...
    DustSystemGenerator{var"##OdinModel#287"}(var"##OdinModel#287"(0, [:C_new, :S, :E_chain, :I_chain, :R, :V], [:N_age, :k_E, :k_I, :t_latent, :t_infectious, :vaccine_efficacy, :S_0, :R_0, :V_0, :vacc_rate, :R0_time, :R0_value, :sp_time, :sp_value, :dP1_time, :dP1_value, :dP2_time, :dP2_value], false, false, true, true, Dict{Symbol, Array}()))
...
# Simulate
result = Odin.dust_system_simulate(sys, sim_times)
...
simple_pars_1 = (N_age=3.0, k_E=1.0, k_I=1.0,
                 ...
                 S_0=S_0 .+ R_0 .+ V_0)
sys_c1 = Odin.dust_system_create(yf_delay_simple, simple_pars_1; dt=1.0, seed=1)
Odin.dust_system_set_state_initial!(sys_c1)
st1 = Odin.dust_system_state(sys_c1)
ic_off1 = N_age + N_age + N_age * 1
st1[ic_off1 + 2, 1] = n_seed
st1[N_age + 2, 1] -= n_seed
Odin.dust_system_set_state!(sys_c1, st1)
r1 = Odin.dust_system_simulate(sys_c1, compare_times)
...
simple_pars_2 = (N_age=3.0, k_E=4.0, k_I=3.0,
                 t_latent=5.0, t_infectious=5.0, R0=3.0,
                 S_0=S_0 .+ R_0 .+ V_0)
sys_c2 = Odin.dust_system_create(yf_delay_simple, simple_pars_2; dt=1.0, seed=1)
Odin.dust_system_set_state_initial!(sys_c2)
st2 = Odin.dust_system_state(sys_c2)
ic_off2 = N_age + N_age + N_age * 4
st2[ic_off2 + 2, 1] = n_seed
st2[N_age + 2, 1] -= n_seed
Odin.dust_system_set_state!(sys_c2, st2)
r2 = Odin.dust_system_simulate(sys_c2, compare_times)
...
sys_nv = Odin.dust_system_create(yf_delay, pars_novacc; dt=1.0, seed=42,
                                  n_particles=n_particles)
Odin.dust_system_set_state_initial!(sys_nv)
st_nv = Odin.dust_system_state(sys_nv)
for p in 1:n_particles
    st_nv[i_chain_idx_2_1, p] = n_seed
end
Odin.dust_system_set_state!(sys_nv, st_nv)
result_nv = Odin.dust_system_simulate(sys_nv, sim_times)
...
@benchmark begin
    sys_b = Odin.dust_system_create($yf_delay, $pars; dt=1.0, seed=42,
                                     n_particles=10)
    Odin.dust_system_set_state_initial!(sys_b)
    Odin.dust_system_simulate(sys_b, $sim_times)
end
```
...
| Simulate         | `dust_system_simulate()` with manual state seeding  |
