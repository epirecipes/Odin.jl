...
```
    ...
    DustSystemGenerator{var"##OdinModel#277"}(var"##OdinModel#277"(3, [:S, :I, :R], [:beta, :gamma, :I0, :N], true, false, true, false, false, Dict{Symbol, Array}()))
...
```
    ...
    DustSystemGenerator{var"##OdinModel#278"}(var"##OdinModel#278"(4, [:S, :E, :I, :R], [:beta, :gamma, :sigma, :I0, :N], true, false, true, false, false, Dict{Symbol, Array}()))
