...
sys_nr <- dust_system_create(gen, pars_no_relapse, ode_control = dust_ode_control())
...
sys_hr <- dust_system_create(gen, pars_high_relapse, ode_control = dust_ode_control())
