...
sys <- System(yf_vtrack, pars, n_particles = n_particles,
                          dt = 1, seed = 42)
...
sys_nv <- System(yf_vtrack, pars_novacc, n_particles = n_particles,
                             dt = 1, seed = 42)
...
| Create system | `System(gen, pars, n_particles, dt, seed)` |
| Simulate | `simulate(sys, times)` |
