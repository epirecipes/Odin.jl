...
```
    ...
    DustSystemGenerator{var"##OdinModel#277"}(var"##OdinModel#277"(0, [:S, :E, :I, :R, :D, :cases_inc], [:n_age, :n_vax, :contact, :N0, :S0, :I0, :beta, :sigma, :gamma, :mu, :ve1, :ve2, :alpha_cases], false, false, true, true, false, Dict{Symbol, Array}()))
