...
While the full joint-state model requires manual construction (the product state space is not simply the union of compartments), the categorical `compose()` function handles the simpler case where pathogens affect disjoint compartment sets:
