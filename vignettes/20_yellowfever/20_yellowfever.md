...
```
    ...
    DustSystemGenerator{var"##OdinModel#308"}(var"##OdinModel#308"(0, [:C, :S, :E, :I, :R, :V], [:N_age, :t_latent, :t_infectious, :vaccine_efficacy, :S_0, :E_0, :I_0, :R_0, :V_0, :vacc_rate, :R0_time, :R0_value, :sp_time, :sp_value, :dP1_time, :dP1_value, :dP2_time, :dP2_value], false, false, true, true, Dict{Symbol, Array}()))
...
@benchmark dust_system_simulate($yf_seirv, $pars;
    times=$sim_times, dt=1.0, seed=42, n_particles=10)
```

    BenchmarkTools.Trial: 190 samples with 1 evaluation per sample.
     Range (min … max):  19.976 ms … 447.184 ms  ┊ GC (min … max):  0.00% … 95.19%
     Time  (median):     21.277 ms               ┊ GC (median):     0.00%
     Time  (mean ± σ):   26.350 ms ±  42.744 ms  ┊ GC (mean ± σ):  19.45% ± 12.12%

       ▂██▂                                                         
      ▄████▇▁▁▁▄▇▄█▆▇▄▇▄▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▆ ▄
      20 ms         Histogram: log(frequency) by time      45.2 ms <

     Memory estimate: 14.81 MiB, allocs estimate: 110066.
