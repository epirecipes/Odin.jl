...
sys = System(sir, (beta=0.5, gamma=0.1, rho=0.3, I0=10.0, N=1000.0); n_particles=1, seed=42)
reset!(sys)
sol = simulate(sys, collect(1.0:1.0:50.0))
...
# Benchmark
b = @benchmark loglik($uf, $pars) samples=500
...
println("\nLL at true params: $(round(loglik(uf, pars), digits=2))")
