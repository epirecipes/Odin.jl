...
```
    ...
    Odin.DustSystemGenerator{var"##OdinModel#278"}(var"##OdinModel#278"(18, [:S1, :E1, :I1, :R1, :D1, :cum1, :S2, :E2, :I2, :R2, :D2, :cum2, :S3, :E3, :I3, :R3, :D3, :cum3], [:n_Rt_times, :Rt_t, :Rt_v1, :Rt_v2, :Rt_v3, :gamma, :sigma, :ifr, :rho, :epsilon, :N1, :N2, :N3, :I0_1, :I0_2, :I0_3, :c12, :c13, :c23], true, false, true, true, true, Dict{Symbol, Array}()))
...
```
    ...
    Total observed cases: 929599
    Cases per region: [571669, 329671, 28259]
...
```
    ...
    Log-likelihood at true parameters: -807.5
...
```
    ...
    8×2500 Matrix{Float64}:
     ...
     1.00499   1.00499   1.00545   1.00545      1.00991   1.00978   1.00978
...
```
    ...
    Shared parameters:
      ...
      IFR: 0.00512 [0.00502, 0.00522]  (true=0.005)
