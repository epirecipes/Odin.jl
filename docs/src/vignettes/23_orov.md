...
```
    ...
    Odin.DustSystemGenerator{var"##OdinModel#277"}(var"##OdinModel#277"(0, [:D_Ih, :D_Sv, :S_h, :E_h, :I_h_asym, :I_h_sym0, :I_h_sym1, :R_h_temp, :I_h_sym2, :R_h, :S_v, :E_v, :I_v], [:k_delay, :delay_tau, :gamma, :theta, :pi_relapse, :sigma, :psi, :epsilon, :kappa, :omega, :mu, :m, :a, :b_h, :b_v, :I_init_h, :I_init_v], true, false, false, true, false, Dict{Symbol, Array}()))
...
```
    ...
    BenchmarkTools.Trial: 1414 samples with 1 evaluation per sample.
     ...
     Memory estimate: 487.89 KiB, allocs estimate: 365.
